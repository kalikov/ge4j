...
class EngineImpl implements Engine, EngineComponent {
    ...
    private final ExecutableEvent<MainFunction> engineCycle = new MultiDelegate<>();
    ...
    @Managed
    public EngineImpl(MillisProvider millisProvider) {
    ...
    @Override
    public Event<MainFunction> engineCycle() {
        return engineCycle;
    }
...
//            _UpdateMouse();
    ...
    private void cycle() throws InterruptedException {
        ...
        if (delta < fixedDelta) {
            ...
            long normalizedDelta = delta > 200 ? (fixedDelta > 0 ? fixedDelta : 10) : delta;
            ...
            engineCycle.execute(function -> function.run(normalizedDelta));
